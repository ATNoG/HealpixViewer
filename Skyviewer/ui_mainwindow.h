...
**
** Created: Mon Jul 25 18:12:03 2011
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/icons/selectall.gif"), QSize(), QIcon::Normal, QIcon::Off);
        actionSelectAll->setIcon(icon6);
        actionDeselectAll = new QAction(MainWindow);
        actionDeselectAll->setObjectName(QString::fromUtf8("actionDeselectAll"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/icons/deselectall.gif"), QSize(), QIcon::Normal, QIcon::Off);
        actionDeselectAll->setIcon(icon7);
